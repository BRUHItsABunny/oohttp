...
import (
	...
	"github.com/BRUHItsABunny/oohttp/internal/httpsfv"
...
type Framer struct {
	...
	// HeaderPriority, if non-nil, is the priority attached to every HEADERS
	// frame written by this Framer. It is a github.com/BRUHItsABunny/oohttp
	// extension used to match the HEADERS frame of the impersonated client.
