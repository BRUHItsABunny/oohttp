...
func testTransportPoolConnHTTP2NoStrictMaxConcurrentRequests(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		dt := newTransportDialTester(t, http2Mode, func(srv *Server) {
			srv.HTTP2 = &HTTP2Config{
...
func TestTransportPoolDisableKeepAlives(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		dt := newTransportDialTester(t, http1Mode, func(tr *Transport) {
...
func newTransportDialTester(t *testing.T, mode testMode, opts ...any) *transportDialTester {
	...
	dt.cst = newClientServerTest(t, mode, HandlerFunc(func(w ResponseWriter, r *Request) {
		...
		io.ReadAll(r.Body)
	}), append([]any{optFakeNet, func(tr *Transport) {
...
func (dt *transportDialTester) roundTrip(opts ...any) *transportDialTesterRoundTrip {
	...
	go func() {
		...
		req, _ := NewRequestWithContext(ctx, "POST", proto+"://"+host, pr)
