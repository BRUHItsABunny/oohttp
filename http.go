...
// protocolSetHTTP3 enables HTTP/3 in p.
//
// Upstream push-linknames this into golang.org/x/net's HTTP/3 tests; this fork
// must not, or the symbol clashes with the one net/http defines whenever both
// packages end up in the same binary. This fork does not support HTTP/3.
